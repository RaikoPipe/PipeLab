...
pipe_stock = {0: 100, 1:100, 2: 100, 3: 100} #: Part IDs pointing the amount of parts available for assembly.
...
weights = Weights(path_length=1, cost=100, distance_to_obstacles=0) #: Weights used if search algorithm is a multi-criteria search algorithm (mca*, mcsa*)
