...
class Solution:
    ...
    definite_path: DefinitePath # solution path (Position with part used to get there)
    total_definite_trail: dict[Pos:int] #  shows which pos is occupied by what part id
    layouts: list[Trail]
