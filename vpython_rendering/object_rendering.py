...
from vpython_rendering.default_data import default_mounting_wall, default_scene, default_obstacle, \
    pipe_corner, default_pipes

"""functions for vpython_rendering single objects (or compound objects)"""
